...
const { videoState, removeWatchLater } = useVideo();
    ...
    <main className="main-cont">
        ...
        <div className="right-body">
            ...
            {watchLater.map((video)=>(
                 ...
                 {drop? (
                     <ul className="dp-ul">
                 <li className="dp-item" onClick={()=>removeWatchLater(token, video._id)}><span><i className="fas fa-clock
                 card-icon"></i></span>Remove</li>
