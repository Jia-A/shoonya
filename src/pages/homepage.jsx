...
const { videoState, getWatchLater, removeWatchLater, getLikes, removeLikes, getHistory, deleteVideoFromPlaylist,
createPlaylist, addVideoToPlaylist } = useVideo();
...
videoExistInPlaylist(playlist) ? deleteVideoFromPlaylist(currentVideo._id, playlist._id, token) :
...
<div className="App">
    ...
    <main className="main-cont">
        ...
        <div className="right-body">
            <div className="chips">
                <ul className="category-list">
                    <li className="list-item" onClick={()=>filterDispatch({type : "CLEAR_FILTER", payload :
                        {...filterState.allVideos}})}>All</li>
                ...
                <article className="video-card" key={video._id}>
                    ...
                    <div className="content">
                        ...
                        <div className="card-icons">
                            ...
                            <button className="dp-btn" onClick={()=> userloginCheck(token, video)}><i
                                    className="fas fa-list card-icon"></i>Playlist</button>
                        </div>
                    </div>
                </article>
                ))}
        ...
        <Modal isOpen={playlistModal} style={customStyle}>
            ...
            <main>
                <label>Name </label>
                <input className="playlist-inp" type="text" value={newPlaylist} onChange={(e)=>
